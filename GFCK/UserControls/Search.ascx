    ...
    <div class="indent">
                    ...
                    <div class="inn3">
                        <div class="inn4">
                            <input type="hidden" name="main_page" value="advanced_search_result" /><input type="hidden"
                                name="search_in_description" value="1" /><input type="text" name="keyword" size="6"
        ...
        <div class="col2">
            <div style="padding-left: 4px;">
                ...
                <input type="image" src="/images/buttons/english/b_search.gif" alt="Search" title=" Search " /><br />
            </div>
        </div>
        <div class="clear">
        </div>
